import { radicalLoader } from '../../js/utils/radicalLoader.js';

describe('RadicalLoader multi-language support for WordComposer', () => {
    const languages = ['chinese', 'japanese', 'korean'];
    const level = 'basic';

    test.each(languages)("build + load radicals and get composable words for %s", async (lang) => {
